...
class BuyingAllotment extends Component {
    ...
    componentDidMount = async () => {
        ...
        const allotment = await api.getAllotmentByNumber(number)

        this.setState({
            id: allotment.data.data.id,
    ...
    render() {
        const { errors,id, number, allotment_width, allotment_length, price, status, user_id } = this.state;
        return (
            <Wrapper>
